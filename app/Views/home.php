...
<?= $this->section('content') ?>
    <div class="bg-img-hero-bottom gradient-overlay-half-black-gradient space-1 text-center"
         style="background-image: url(https://placehold.co/1920x800);">
                                        ...
                                        <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3 align-items-end">
                                            ...
                                            <div class="col-sm-5 mb-4 mb-lg-0">
                                                ...
                                                <div class="input-group input-group-tranparent input-group-borderless input-group-radiusless u-search-slide-down__input rounded-0 px-1">
                                                    <input type="search" class="form-control" placeholder="Kode Booking"
        ...
        <div class="container space-bottom-1 space-1">
            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="min-height-350 bg-img-hero rounded-border p-5 gradient-overlay-half-bg-gradient-v4 gradient-overlay transition-3d-hover shadow-hover-2 dropdown"
                         style="background-image: url(https://placehold.co/630x350/png);">
                        <header class="w-100 d-flex justify-content-between mb-3">
                            <div class="position-relative">
                                <a href="javascript:void();"
                                   class="destination text-white font-weight-bold font-size-21 pb-3 mb-3 text-lh-1 d-block">Bus
                                    I</a>
                            </div>
                        </header>
                    </div>
                ...
                <div class="col-md-6 col-xl-3 mb-3 mb-md-4 pb-1">
                    <div class="min-height-350 bg-img-hero rounded-border p-5 gradient-overlay-half-bg-gradient-v4 gradient-overlay transition-3d-hover shadow-hover-2 dropdown"
                         style="background-image: url(https://placehold.co/300x350/png);">
                        <header class="w-100 d-flex justify-content-between mb-3">
                            <div class="position-relative">
                                <a href="javascript:void();"
                                   class="destination text-white font-weight-bold font-size-21 pb-3 mb-3 text-lh-1 d-block">Bus
                ...
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-one-example1" role="tabpanel"
                            ...
                            <h4 class="font-size-16 font-weight-semi-bold">
                                2. Penumpang harus sudah siap 30 Menit sebelum jam keberangkatan bus. Bila datang
                                terlambat dan bus sudah berangkat tiket hangus ( tidak dapat ditagih kembali).
                            </h4>
                            ...
                            <h4 class="font-size-16 font-weight-semi-bold">
                                ...
                                <ul class="list-group-borderless list-group-horizontal list-group-flush row">
                                    <li class="col-md-5 list-group-item">
                                        <div class="flex-horizontal-center mb-3"><i
                                                    class="fas fa-circle mr-3 font-size-8 text-danger"></i> H-1 (H -
                                            Minus 1 ) 50%
                                        </div>
                                        <div class="flex-horizontal-center mb-3"><i
                                                    class="fas fa-circle mr-3 font-size-8 text-danger"></i> H-2 dst ( H
                                            - Minus 2 dan seterusnya ) 35%
                                        </div>
                                        <div class="flex-horizontal-center mb-3"><i
                                                    class="fas fa-circle mr-3 font-size-8 text-danger"></i> di hari
                                            H ( Tiket hangus)
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <h4 class="font-size-16 font-weight-semi-bold">
                                4. Selama perjalanan para penumpang diharapkan menempatkan barang - barang bawaaana pada
                                tempat yang mudah diawasi dan tidak menggangu penumpang lain.
                            </h4>

                            <h4 class="font-size-16 font-weight-semi-bold">
                                5. Setiap penumpang yang turun di perjalanannya. para penumpang diwajibkan kembali untuk
                                mengontrol barang bawaanya.
                            </h4>

                            <h4 class="font-size-16 font-weight-semi-bold">
                                6. Para Penumpang diharapkan tidak meninggalkan barang berharga didalam bus, selama
                                penumpang mendapat service makan, minun dan penyebarangan.
                            </h4>

                            <h4 class="font-size-16 font-weight-semi-bold">
                                7. barang Berharga mohon dititipkan ke Kru kami, kehilangan dan kerusakaan barang adalah
